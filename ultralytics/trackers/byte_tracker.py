...
class STrack(BaseTrack):
    ...
    Methods:
        predict(): Predict_result the next state of the object using Kalman filter.
        multi_predict(stracks): Predict_result the next states for multiple tracks.
...
class BYTETracker:
    ...
    def update(self, results, img=None):
        ...
        # Predict_result the current location with KF
    ...
    def multi_predict(self, tracks):
        """Predict_result the next states for multiple tracks using Kalman filter."""
